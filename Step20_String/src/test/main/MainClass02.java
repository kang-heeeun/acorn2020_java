...
public class MainClass02 {
	public static void main(String[] args) {
		...
		String line3 = "김구라abcd  ef해골  as bd4 원숭이  주뎅이 fdfff 덩어리";
		String[] result3 = line3.split("[a-z0-9 ]+");
		
		String line4 = "김구라바보, 해골바보, 원숭이바보";
		String result4 = line4.replace("바보", "천재");
		
		String line5 = "abc 가나 123 efg @!$ def 456";
		//정규 표현식으로 특수문자 제거 
		String result5 = line5.replaceAll("[^A-Za-z0-9]+", ""); //특수문자가아닌한글자 한번이상반복
		/*
		 * in javascript => /[^\w]/
		 * in java => "[^\\w]"
		 * 
		 ...
		 * in java => "a\\\\b"
		 * 
		 * - java에서 정규표현식을 작성할때 역슬레시를 하나 넣고 싶으면 2개를 넣으면 된다
		 * 
		 */
		String result6 = line5.replaceAll("[^\\w]", "");
		String result7 = line5.replace("[\\w]", "");
